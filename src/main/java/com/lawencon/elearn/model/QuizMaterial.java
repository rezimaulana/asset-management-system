...
@Entity
@Table(name="quiz_material")
public class QuizMaterial extends BaseModel {
	@Column(name = "quiz_code", nullable=false, length = 10, unique=true)
	private String code;
	@Column(name = "quiz_subject", nullable=false, length = 200)
